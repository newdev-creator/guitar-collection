 ...
 */
final class Version20220324100948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post_brand (post_id INT NOT NULL, brand_id INT NOT NULL, INDEX IDX_8B4975B74B89032C (post_id), INDEX IDX_8B4975B744F5D008 (brand_id), PRIMARY KEY(post_id, brand_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
